...
## Objective
Maintain `agent-design-patterns` as a reliable, useful, and test-first project aligned with its primary promise:
> Comprehensive guide to agentic patterns with code examples.
